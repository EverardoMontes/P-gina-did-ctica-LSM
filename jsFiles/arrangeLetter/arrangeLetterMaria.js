document.addEventListener('DOMContentLoaded', () => {
    ...
    const letterButtonsContainer = document.getElementById('letter-buttons3');
    const spacesContainer = document.getElementById('spaces3');
    const resetButton = document.getElementById('reset3');
    let spaces = [];
